...
class _MenuVerdeState extends State<MenuVerde> {
 ...
 List allDescriptions =[
    'Existem diversas formas de calcular o diâmetro de lentes. \ Essa opção venho pra facilitar.',
        ...
        Container(
          ...
          child: ListView(
           ...
           children: <Widget>[
            ...
            SizedBox(width: 15.0),
            getMenuCard('assets/', 'Agilidade aos seus pedidos', 'Pedido Laboratório', 'O.S'),
            SizedBox(width: 15.0),
