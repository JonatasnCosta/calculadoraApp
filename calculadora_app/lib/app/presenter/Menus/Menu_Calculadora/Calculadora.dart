        ...
        return <pw.Widget>[
          ...
          pw.Row(
            children: [
              ...
              pw.Paragraph(
                  text: _controllerMaiorDiagonal.text,
                  style: pw.TextStyle(
                    fontSize: 30.0,
                  )),
            ],
      ...
      body: ListView(
        children: <Widget>[
          ...
          Row(
            ...
            children: <Widget>[
              Padding(
                padding: EdgeInsets.only(top: 10.0, left: 60.0, bottom: 400.0),
                child: Text(
                  "Diâmetro:",
                  style: TextStyle(
                      fontFamily: 'Montserrat',
              ...
              Padding(
                padding: EdgeInsets.only(top: 10.0, left: 10.0, bottom: 400.0),
                child: Text(
                  fn.format(diametro),
                  style: TextStyle(
                      fontFamily: 'Montserrat',
              ...
              Padding(
                padding: EdgeInsets.only(top: 10.0, left: 20.0, bottom: 400.0),
                child: IconButton(
                ...
                child: IconButton(
                  ...
                  onPressed: () async {
                    await Printing.sharePdf(
                        bytes: pdf.save(), filename: 'Diâmetro de lentes.pdf');
                  },
                ),
              )
            ],
