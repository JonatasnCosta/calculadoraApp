...
class _FuncaoAdicaoState extends State<FuncaoAdicao> {
  ...
  var maskFormatterODPerto = new MaskTextInputFormatter(
      mask: '##.##', filter: {"#": RegExp(r'[+0-9]')});
  var maskFormatterOEPerto = new MaskTextInputFormatter(
      mask: '##.##', filter: {"#": RegExp(r'[+0-9]')});
  ...
  var esfODlonge, esfOElonge, esfODperto, esfOEperto;
    ...
    return Scaffold(
      body: ListView(
        children: <Widget>[
          ...
          Padding(
            padding:
                EdgeInsets.only(top: 5.0, left: 20.0, right: 30.0, bottom: 5.0),
            child: RaisedButton(
                color: Color(0xff399d63),
